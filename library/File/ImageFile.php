<?php
	...
	class ImageFile extends File {
		...
		public function saveResized($trgUri, $proportions, $crop = false, $dontDistort = true, $cropOffsets = array(50.0, 20.0), $mode = 0644) {
			$image = $this->getResized($trgUri, $proportions, $crop, $dontDistort, $cropOffsets, $mode);
		 ...
		 */
		protected function getResized($trgUri, $proportions, $crop, $dontDistort, $cropOffsets, $mode) {
